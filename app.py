...
st.markdown("""
    <style>
    .stApp {
        background-image: url(r'file:///C:/Users/user/Desktop/IT vedant/ml project/1 campuse placement/campus.jpg');
...
if submit_button:
    try:
        ...
        if prediction[0] == 1:
            st.success("Prediction: you wil Placed")
        else:
            st.warning("Prediction: you will Not Placed")
